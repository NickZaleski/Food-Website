...
function calc() {
  ...
  var result = document.querySelector('.calculating__result span'); // создаем переменные, в которых уже выбрана женщина и коэффицент
  // а так же рост, вес и возраст

  var sex, height, weight, age, ratio; // если в локал сторадж есть item с полом.
  ...
  if (localStorage.getItem('sex')) {
    ...
    sex = 'female'; // и установить его в локал сторадж
  ...
  function initLocalSettings(selector, activeClass) {
    ...
    var elements = document.querySelectorAll(selector); // в каждом элементе удаяляется класс

    elements.forEach(function (elem) {
      elem.classList.remove(activeClass); // если атрибут id у элемента строго равен обхекту sex
  ...
  initLocalSettings('#gender div', 'calculating__choose-item_active'); // запускаем фукнцию для селектора,  а так же добавляем класс активности

  initLocalSettings('.calculating__choose_big div', 'calculating__choose-item_active'); // функция которая считает все значения

  function calcTotal() {
    // если нет пола или нет роста или нет веса или возраста или коэффицента, то
    if (!sex || !height || !weight || !age || !ratio) {
      // покажи результат пустой
      result.textContent = '____'; // остановить выполнение фукнции
  ...
  calcTotal(); // получаем статическую информацию (та что кнопочная)
  ...
  function getStaticInformation(selector, activeClass) {
    ...
    var elements = document.querySelectorAll(selector); // каждый элемент перебираем и обрабатываем событие по клику
    ...
    elements.forEach(function (elem) {
      elem.addEventListener('click', function (e) {
        ...
        e.target.classList.add(activeClass); // вызываем функцию, которая даёт нам возможность посчитать результат
  ...
  getStaticInformation('#gender div', 'calculating__choose-item_active'); // вызываем статическую фукнцию для разных типов активности

  getStaticInformation('.calculating__choose_big div', 'calculating__choose-item_active'); // создание функции для динамической информации

  function getDynamicInformation(selector) {
    // добавили переменную инпут с и по селектору выбрали селектор
    var input = document.querySelector(selector); // на поле для ввода повесили событие
...
function forms(formSelector, modalTimerId) {
  ...
  function showThanksModal(message) {
    var prevModalDialogue = document.querySelector('.modal__dialog');
...
function slider(_ref) {
  ...
  var slideCounterCondition = function slideCounterCondition() {
    if (slides.length < 10) {
      current.textContent = "0".concat(slideIndex);
    } else {
      current.textContent = slideIndex;
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_3__["default"])('[data-close]', '.modal', modalTimerId);
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_4__["default"])('.timer', '2020-07-05');
